...
button = WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(locators.RESET_PASSWORD_BUTTON))
button.click()

button = WebDriverWait(driver, 3).until(expected_conditions.element_to_be_clickable(locators.LOGIN_BUTTON_ON_RESET_PASSWORD_PAGE))
button.click()
